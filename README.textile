...
<pre><code>val scalaLibraryOSGi = "com.weiglewilczek.scala-lang-osgi" % "scala-library" % "2.9.0"
val scalaCompilerOSGi = "com.weiglewilczek.scala-lang-osgi" % "scala-compiler" % "2.9.0"
</code></pre>
